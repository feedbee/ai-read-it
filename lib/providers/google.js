...
class GoogleProvider extends Provider {
     ...
     * @param {bool} [options.detectLanguage] - Optional. Try to detect text language with Google Translate API if the language is not provided explicitely in textToSpeech options
     */
    constructor(options) {
        super(options);
